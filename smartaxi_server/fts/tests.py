...
class PollTest(LiveServerTestCase):
    ...
    def test_can_create_new_poll_via_admin_site(self):
        ...
        self.assertIn(u'Administración de Django', body.text)

        # She types in her username and passwords and hits return
        username_field = self.browser.find_element_by_name('username')
        username_field.send_keys('phantomis')

        password_field = self.browser.find_element_by_name('password')
        password_field.send_keys('mondo10')
        ...
        new_poll_link = self.browser.find_element_by_link_text(u'Añadir poll')
        new_poll_link.click()
        ...
        save_button = self.browser.find_element_by_css_selector("input[value='Grabar']")
        save_button.click()
